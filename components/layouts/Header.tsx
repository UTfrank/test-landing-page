...
const Header = () => {
  return (
    <header className="w-full">
      <Navbar />
      <MobileNav />
      <div className="w-full md:px-[72px] px-[26px] flex flex-col md:flex-row items-center justify-center ">
        <div className="flex flex-col lg:gap-y-[72px] max-[1128px]:!gap-y-[47px] md:w-1/2">
          ...
          <div className="flex md:flex-row justify-center items-center flex-col md:w-full font-plus-jakarta-sans mb-4">
        ...
        <div className="relative flex justify-center md:w-1/2">
          <Image
            src={circle}
            alt="hero-image"
            className="lg:w-[600px] lg:h-[600px] md:w-[500px] md:h-[500px] max-[1128px]:!w-[450px] max-[1128px]:!h-[450px] absolute top-[55%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10"
            objectFit="contain"
          />
          <Image
            src={man}
            alt="hero-image"
            className="z-10 object-contain lg:w-11/12 md:w-11/12 relative"
            objectFit="contain"
          />
          <Image
            src={card}
