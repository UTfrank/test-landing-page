...
const Navbar = () => {
  return (
    <nav className='w-full px-[72px] py-[30px] md:flex justify-between items-center hidden'>
      <div className='flex flex-row items-center'>
        <Link href='/' className='flex items-center gap-x-[26px] font-plus-jakarta-sans mr-[134px]'>
